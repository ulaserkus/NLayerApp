...
namespace NLayer.Service.Services
{
    public class ProductServiceWithNoCache : Service<Product>, IProductService
    {
        ...
        public ProductServiceWithNoCache(IProductRepository productRepository, IGenericRepository<Product> repository, IUnitOfWork unitOfWork, IMapper mapper) : base(repository, unitOfWork)
        {
